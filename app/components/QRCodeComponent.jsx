...
const QRCodeComponent = () => {
  ...
  const base64UserId = btoa(encodeURIComponent(userId).replace(/%([0-9A-F]{2})/g, (match, p1) => String.fromCharCode('0x' + p1)));

  console.log(base64UserId);
  ...
  return (
    <div className="qr-code-section bg-gray-100 rounded-lg p-6 text-center mt-10">
      ...
      <p className="text-gray-600 mt-3">
        Scansiona il codice QR per scaricare l'app direttamente sul tuo
        dispositivo!
      </p>
    </div>
  );
